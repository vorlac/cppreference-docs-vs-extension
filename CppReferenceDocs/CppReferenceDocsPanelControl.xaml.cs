...
namespace CppReferenceDocsExtension
{
    ...
    public partial class CppReferenceDocsPanelControl : UserControl
    {
        ...
        public CppReferenceDocsPanelControl()
        {
            try
            {
                InitializeComponent();
                ...
                Loaded += CppReferenceDocsPanelControl_Loaded;
        ...
        private async void InitializeWebView()
        {
            try
            {
                ...
                string userDataFolder = Path.Combine(
                    ...
                    "VS2022CppReferenceDocsExtension");
        ...
        private static void HandleError(string message, Exception exception = null) =>
            Log.Error(exception, $"{nameof(CppReferenceDocsPanelControl)} - {message}");

        private void WebBrowserWindowControl_Unloaded(object sender, RoutedEventArgs e) =>
            Log.Verbose("Unloaded Event Handler");

        private async void CppReferenceDocsPanelControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                // parent control.
                rightFiller.Width = Math.Abs(rightFiller.Width - 1.0) < 0.0001 ? 0.0 : 1.0;
        ...
        private async Task NavigateToHomeAsync()
        {
            try
            {
                IDocsBrowserSettings settings = GetService<IDocsBrowserSettings>();
